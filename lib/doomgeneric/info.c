...
// 27KB states table -> IRAM (free up DRAM)
DOOM_IRAM_TABLE state_t states[NUMSTATES] = {
...
// 12KB mobjinfo table -> IRAM (free up DRAM)
DOOM_IRAM_TABLE mobjinfo_t mobjinfo[NUMMOBJTYPES] = {
