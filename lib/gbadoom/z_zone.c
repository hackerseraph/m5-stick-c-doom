...
// M5StickC Plus optimization: stripped sound, forced medium difficulty
// Trying 96KB after removing sound system overhead
//static int memory_size = 8192*1024;  // Original
//static int memory_size = 256*1024;   // GBA DOOM default  
//static int memory_size = 128*1024;   // First try
//static int memory_size = 64*1024;    // Second try
static int memory_size = 96*1024;      // After sound removal
